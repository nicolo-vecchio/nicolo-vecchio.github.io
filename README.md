...
---
## Output data
Given the lenghty nature of the output generated by the model, the files have been included in the html repository. Every line of the output represents a time-step, and the second to last numeric value of every line (under the column F) represents the number of hosts booked during that time step.
